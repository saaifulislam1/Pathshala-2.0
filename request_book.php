...
<h2 > Make a book request</h2>

<form class="ui form" action="user_push.php">
  <div class="field">
  
  <div class="field">
    <label>BOOK NAME</label>
    <input type="text" name="name_key1" placeholder="BOOK NAME">
  </div>
  <div class="field">
    <label>AUTHOR NAME</label>
    <input type="text" name="auth_key1" placeholder="AUTHOR NAME">
  </div>
  <div class="field">
    <label>LANGUAGE</label>
    <input type="text" name="lang_key1" placeholder="LANGUAGE">
  </div>
  <div class="field">
    <label>REALESED YEAR</label>
    <input type="text" name="rel_key1" placeholder="REALESED YEAR">
  </div>
